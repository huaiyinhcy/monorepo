...
import{p as i,v as u,a$ as m,C as y,c as _,o as g,a_ as k,ad as b,G as n,j as o,ae as v,k as t,w as r,a as s}from"./chunks/framework.BBpwGDFv.js";import{O as h,E as f}from"./chunks/index.DZlgMEcn.js";const C=`<template>
...
<style scoped></style>
`,D=JSON.parse('{"title":"trans-coord","description":"","frontmatter":{},"headers":[],"relativePath":"pages/packages/trans-coord.md","filePath":"pages/packages/trans-coord.md"}'),j={name:"pages/packages/trans-coord.md"},x=Object.assign(j,{setup(W){const c=i();u(async()=>{c.value=(await m(async()=>{const{default:l}=await import("./chunks/validate.DPa79Dug.js");return{default:l}},__vite__mapDeps([0,1,2,3,4]))).default});const a=i(!0),d=i();return u(async()=>{d.value=(await m(async()=>{const{default:l}=await import("./chunks/minimal.CVpnsPEP.js");return{default:l}},__vite__mapDeps([5,1,2,4]))).default}),(l,e)=>{const p=y("ClientOnly");return g(),_("div",null,[e[2]||(e[2]=k('<h1 id="trans-coord" tabindex="-1">trans-coord <a class="header-anchor" href="#trans-coord" aria-label="Permalink to &quot;trans-coord&quot;">​</a></h1><p>支持<code>墨卡托（Mercator）</code>、<code>WGS84</code>、<code>高德（GCJ02）</code>、<code>百度（BD09）</code>之间的坐标转换，无需调用外部接口，可在<code>本地</code>直接执行。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> i</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @huaiyinhcy/trans-coords</span></span></code></pre></div><h2 id="最小示例" tabindex="-1">最小示例 <a class="header-anchor" href="#最小示例" aria-label="Permalink to &quot;最小示例&quot;">​</a></h2>',5)),b(n(t(h),null,null,512),[[v,a.value]]),n(p,null,{default:r(()=>[n(t(f),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{a.value=!1}),vueCode:t(w)},{vue:r(()=>[n(t(d))]),_:1},8,["vueCode"])]),_:1}),e[3]||(e[3]=o("h2",{id:"校验本工具",tabindex:"-1"},[s("校验本工具 "),o("a",{class:"header-anchor",href:"#校验本工具","aria-label":'Permalink to "校验本工具"'},"​")],-1)),e[4]||(e[4]=o("p",null,[s("你可以通过 "),o("a",{href:"https://lbs.amap.com/tools/picker",target:"_blank",rel:"noreferrer"},"高德坐标拾取工具"),s(" 跟 "),o("a",{href:"https://api.map.baidu.com/lbsapi/getpoint/index.html",target:"_blank",rel:"noreferrer"},"百度坐标拾取工具"),s(" 来进行校验")],-1)),e[5]||(e[5]=o("p",null,"当前坐标是北京故宫博物馆",-1)),b(n(t(h),null,null,512),[[v,a.value]]),n(p,null,{default:r(()=>[n(t(f),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[1]||(e[1]=()=>{a.value=!1}),vueCode:t(C)},{vue:r(()=>[n(t(c))]),_:1},8,["vueCode"])]),_:1})])}}});export{D as __pageData,x as default};
