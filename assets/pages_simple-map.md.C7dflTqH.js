const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/od-map.BMx6gcmq.js","assets/chunks/index.CXKZS7CZ.js","assets/chunks/framework.BufGfe89.js","assets/chunks/index.C7-Tf2T7.js"])))=>i.map(i=>d[i]);
...
`,Z=JSON.parse('{"title":"OpenLayers方法封装","description":"","frontmatter":{},"headers":[],"relativePath":"pages/simple-map.md","filePath":"pages/simple-map.md"}'),C={name:"pages/simple-map.md"},V=Object.assign(C,{setup(k){const i=r();u(async()=>{i.value=(await m(async()=>{const{default:o}=await import("./chunks/od-map.BMx6gcmq.js");return{default:o}},__vite__mapDeps([0,1,2,3]))).default});const a=r(!0),s=r();return u(async()=>{s.value=(await m(async()=>{const{default:o}=await import("./chunks/index.CXKZS7CZ.js").then(e=>e.i);return{default:o}},__vite__mapDeps([1,2]))).default}),(o,e)=>{const d=h("ClientOnly");return _(),L("div",null,[e[2]||(e[2]=g('<h1 id="openlayers方法封装" tabindex="-1">OpenLayers方法封装 <a class="header-anchor" href="#openlayers方法封装" aria-label="Permalink to &quot;OpenLayers方法封装&quot;">​</a></h1><p>OpenLayers 常用方法封装，例如：行政区边界、底图裁切、底图换色、立体边界、od飞线图等。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> i</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @huaiyinhcy/simple-map</span></span></code></pre></div><h2 id="如何使用" tabindex="-1">如何使用 <a class="header-anchor" href="#如何使用" aria-label="Permalink to &quot;如何使用&quot;">​</a></h2><ul><li>加载天地图影像底图与影像注记</li><li>底图裁切与换色</li><li>行政区边界与立体边界</li></ul>',6)),p(n(t(y),null,null,512),[[f,a.value]]),n(d,null,{default:l(()=>[n(t(v),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{a.value=!1}),vueCode:t(x)},{vue:l(()=>[n(t(s))]),_:1},8,["vueCode"])]),_:1}),e[3]||(e[3]=c("h2",{id:"od飞线图-与-图例",tabindex:"-1"},[b("od飞线图 与 图例 "),c("a",{class:"header-anchor",href:"#od飞线图-与-图例","aria-label":'Permalink to "od飞线图 与 图例"'},"​")],-1)),p(n(t(y),null,null,512),[[f,a.value]]),n(d,null,{default:l(()=>[n(t(v),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[1]||(e[1]=()=>{a.value=!1}),vueCode:t(B)},{vue:l(()=>[n(t(i))]),_:1},8,["vueCode"])]),_:1})])}}});export{Z as __pageData,V as default};
